                ...
                {title: "ABOUT"},
                {
                    html:
                        `<div class="about_blurb" style="padding-bottom: 30px; height=100%">
                            ...
                            <p>I have been a multi-media artist for over a decade, inspired heavily by my passion for technology. My artistic practice is focused primarily on film, photography, sculpture, and audio - exporing themes of digitization as process, media representation, mental health, and societal inequity.</p>
                            <p>Inspired by my work as an artist, in my professional tech work over the past three years, I have primarily helped film and entertainment companies optimize operational efficiency, alleviate technological debt, and expand artistic possibilities using machine learning, advanced graphics and vision theory, and forward-thinking engineering and architecture best practices.</p>
                            <p>Please reach out to me if you are interested in working together in either an artistic or technological capacity. I am available on a consulting/freelance basis for both small and large projects, and occasionally available for pro-bono work on certain projects.</p>
